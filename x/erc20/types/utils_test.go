...
func TestEqualAliases(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			"different lengths",
			[]string{},
			[]string{"atto commercionetworkethermint"},
			false,
		},
		{
			"different values",
			[]string{"attocommercionetworkethermint"},
			[]string{"atto commercionetworkethermint"},
			false,
		},
		{
			"same values, unsorted",
			[]string{"atto commercionetworkethermint", "acommercionetworkethermint"},
			[]string{"acommercionetworkethermint", "atto commercionetworkethermint"},
			false,
		},
		{
			"same values, sorted",
